...
<aside class="side">
  ...
  <nav class="menu">
    ...
    <?=tvs_admin_link('nova_noticia','nova-noticia.php','Notícia Rápida',$activeAdmin)?>
    <?=tvs_admin_link('drafts','drafts.php','Revisões Pendentes',$activeAdmin)?>
    ...
    <a href="../videos.php" target="_blank" rel="noopener">Ver vídeos</a>
