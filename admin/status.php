...
$rpiaCfg=function_exists('tvs_heygen_load_config') ? tvs_heygen_load_config([]) : [];
// Fonte canônica única: helper HeyGen combina configuração persistente e ambiente
// sem exigir duplicação manual entre reporter_ia_config.json e heygen_config.json.
