...
HTML;
  ...
  echo "Boletim config UI: aplicada.\n";
}elseif(strpos($b,'Seleção automática do apresentador')!==false){
  echo "Boletim config UI: hardening já aplicado.\n";
}else{
  fwrite(STDERR,"Boletim config UI início não encontrado\n");exit(4);
}
